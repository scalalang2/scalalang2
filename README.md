...
- 🎮 Plays Arc Raiders, Zenless Zone Zero and Genshin Impacts.
...
- [upbit-trading-agent](https://github.com/scalalang2/upbit-trading-agent) : Agentic Trading System for Upbit API built with [Agent Framework](https://github.com/microsoft/agent-framework)
